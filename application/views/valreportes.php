                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 py-2">
                                    ...
                                    <form action="<?=base_url()?>Valreporte/hoy" method="get" target="_blank">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <button type="submit" name="btn" value="reporte" class="btn btn-primary btn-block"><i class="fa fa-print"></i>  Imprimir Valorados del Dia </button>
                                            </div>
                                            <div class="col-sm-6">
